...
Tarsos Transcoder is a Java library that enables you to quickly play and process audio encoded as MP3, Flac, Vorbis or about any other audio format in Java. It also provides support for @http@ and other streams.
